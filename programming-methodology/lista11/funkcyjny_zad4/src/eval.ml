...
let eval_op (op : bop) (v1 : value) (v2 : value) : comp =
  match op, v1, v2 with
  | Add,  VInt i1, VInt i2 -> Value (VInt (i1 + i2))
  | Sub,  VInt i1, VInt i2 -> Value (VInt (i1 - i2))
  | Mult, VInt i1, VInt i2 -> Value (VInt (i1 * i2))
  | Div,  VInt i1, VInt i2 -> Value (VInt (i1 / i2))
  | Eq,   VInt i1, VInt i2 -> Value (VBool (i1 = i2))
  | Lt,   VInt i1, VInt i2 -> Value (VBool (i1 < i2))
  | Gt,   VInt i1, VInt i2 -> Value (VBool (i1 > i2))
  | Leq,  VInt i1, VInt i2 -> Value (VBool (i1 <= i2))
  | Geq,  VInt i1, VInt i2 -> Value (VBool (i1 >= i2))
  | Neq,  VInt i1, VInt i2 -> Value (VBool (i1 <> i2))
  | _ -> Exn ""
