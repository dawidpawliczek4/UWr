...
mixfix:
  ...
  | LET; p = pattern; EQ; e1 = mixfix; IN; e2 = mixfix { Let(p, e1, e2) }
  | LET; p = pattern_app; EQ; e1 = mixfix; IN; e2 = mixfix { Let(p, e1, e2) }
  | LET; p = pattern_base; EQ; e1 = mixfix; IN; e2 = mixfix { Let(p, e1, e2) }
